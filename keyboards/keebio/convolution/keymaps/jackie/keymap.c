...
#define JL_RSPC LT(2, KC_SPC) //MT(MOD_RALT, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all(
    ...
    KC_F13,         KC_F14,      KC_TRNS,    KC_HOME,       KC_MS_WH_UP,   KC_END,         KC_PGUP,       KC_PAUS,      KC_HOME,       KC_PGDN,       KC_PGUP,     KC_END,         KC_UP,      KC_MS_UP,    KC_PSCR, KC_DEL,          KC_MS_BTN3,
