...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    JL_CUT_MAC,     KC_PAUS, KC_TAB,     KC_Q,     KC_W,     KC_E,       KC_R,          KC_T,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,         KC_DEL,
    ...
    JL_STACK,       JL_WARP, MO(3),      KC_LCTL,  KC_LALT,  KC_LGUI,    JL_LSPC,       JL_RSPC,      KC_RGUI, KC_RCTL, MO(4),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_all(
  ...
  [2] = LAYOUT_all(
    ...
    KC_F15,         KC_F16,  KC_TRNS,    MS_WHLL,  MS_WHLD,  MS_WHLR,    KC_PGDN,       KC_HOME,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, MS_LEFT, MS_RGHT, KC_TRNS, MS_BTN1,         MS_BTN2,
  ...
  [3] = LAYOUT_all(
   ...
   KC_TRNS,         KC_TRNS, KC_CAPS,    MS_LEFT,  MS_DOWN,  MS_RGHT,    MS_WHLD,       KC_TRNS,      MS_WHLL, MS_WHLD, MS_WHLU, MS_WHLR, MS_LEFT, MS_RGHT, KC_TRNS, KC_PENT,         KC_TRNS,
    ...
    KC_TRNS,        KC_TRNS, KC_TRNS,    KC_TRNS,  KC_TRNS,  KC_TRNS,    MS_BTN1,       KC_CAPS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
  [4] = LAYOUT_all(
