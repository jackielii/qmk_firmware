...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_all(
    ...
    KC_F13, KC_F14, JL_ALT_TAB, JL_ALT_Q,      KC_MS_WH_UP,   KC_END,         KC_PGUP,     KC_PAUS,      KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_UP,      KC_MS_UP,    KC_PSCR, KC_DEL,     KC_MS_BTN3,
  ...
  [3] = LAYOUT_all(
    ...
    KC_F23,  KC_F24,  KC_MCTL, KC_MS_BTN1, KC_MS_UP,   KC_MS_BTN2,  KC_MS_WH_UP,   KC_TRNS, KC_HOME,       KC_PGDN,       KC_PGUP,     KC_END,         KC_UP,      KC_MS_UP,    KC_TRNS, KC_BSLS, KC_TRNS,
   KC_TRNS,  KC_TRNS, KC_CAPS, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_WH_DOWN, KC_TRNS, KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_UP, KC_MS_WH_RIGHT, KC_MS_LEFT, KC_MS_RIGHT, KC_TRNS, KC_PENT, KC_TRNS,
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,     KC_MS_BTN1,    KC_CAPS, KC_TRNS,       KC_TRNS,       KC_TRNS,     KC_TRNS,        KC_TRNS,    KC_TRNS
  ),
  [4] = LAYOUT_all(
    ...
    KC_F23,  KC_F24,  RGB_TOG, RGB_RMOD, RGB_MOD, RGB_HUD, RGB_HUI,       RGB_SAD,  RGB_SAI, RGB_VAD, RGB_VAI, RGB_SPD, RGB_SPI,    KC_MS_UP,    KC_TRNS, DF(0),         DF(1),
