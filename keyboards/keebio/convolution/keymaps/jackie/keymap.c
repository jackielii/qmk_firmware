...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    ...
    KC_F9,       KC_F10,       MO(2),       KC_LALT, KC_LGUI, MO(1), LT(1,KC_SPC), MT(MOD_RGUI, KC_SPC), KC_RALT, KC_RCTL, MO(3),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [3] = LAYOUT_all(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DT_PRNT, DT_DOWN, DT_UP, _______, _______, QK_BOOT,
